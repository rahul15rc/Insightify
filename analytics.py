...
def analytics_page(dataset):
    if dataset:
        ...
        sidebar_space(3)         
        vizuals = st.multiselect("Choose visualizations:", all_vizuals)
        if 'Info' in vizuals:
            st.subheader('Info:')
        ...
        if 'Distribution of Numerical Columns' in vizuals:
            if len(num_columns) == 0:
                ...
                selected_num_cols = multiselect_container('Choose columns for Distribution plots:', num_columns, 'Distribution')
        ...
        if 'Count Plots of Categorical Columns' in vizuals:
            if len(cat_columns) == 0:
                ...
                selected_cat_cols = multiselect_container('Choose columns for Count plots:', cat_columns, 'Count')
        ...
        if 'Box Plots' in vizuals:
            if len(num_columns) == 0:
                ...
                selected_num_cols = multiselect_container('Choose columns for Box plots:', num_columns, 'Box')
        ...
        if 'Variance of Target with Categorical Columns' in vizuals:
            ...
            if len(normal_cardi_columns) == 0:
                ...
                selected_cat_cols = multiselect_container('Choose columns for Category Colored plots:', normal_cardi_columns, 'Category')
